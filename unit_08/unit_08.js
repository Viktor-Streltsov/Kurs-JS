...
function t6() {
    let numInp = +document.querySelector('.i-6').value;
    let i = 0;
    let num = '';
    while (i < numInp) {
        let j = 0;
    ...
    document.querySelector('.out-6').innerHTML = num;
}
...
function t7() {
    let numImp = document.querySelector('.i-7').value;
    let num = '';
    while (numImp >= 0) {
        num += numImp + '_';
        numImp--;
...
function t8() {
    let numOne = +document.querySelector('.i-81').value;
    let numTwo = +document.querySelector('.i-82').value;
    let num = '';
    while (numOne <= numTwo) {
        num += numOne + '_';
        numOne++;
    };
    document.querySelector('.out-8').textContent = num;
}
...
function t9() {
    let numOne = +document.querySelector('.i-91').value;
    let numTwo = +document.querySelector('.i-92').value;
    let num = '';
    if (numOne >= numTwo) {
        while (numTwo <= numOne) {
            num += numTwo + '_';
...
function t11() {
    let grupDiv = document.querySelectorAll('div.div-11');
    let i = 0;
    let strNum = '';
    while (i < grupDiv.length) {
        strNum += grupDiv[i].textContent + '_';
        i++;
    };
    document.querySelector('.out-11').textContent = strNum;
}
...
function t12() {
    let grupDiv = document.querySelectorAll('div.div-12');
    let i = 0;
    while (i < grupDiv.length) {
        grupDiv[i].style.background = 'orange';
        i++;
    };
}
...
function t14() {
    let inpAll = document.querySelectorAll('.i-14');
    let i = 0;
    while (i < inpAll.length) {
        if (inpAll[i].checked){
            document.querySelector('.out-14').textContent = inpAll[i].value;
        };
        i++;
    };
}
