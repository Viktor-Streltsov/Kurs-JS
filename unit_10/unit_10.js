...
let ar2 = ['one', 'two', 3, 4, true, false, 5];
...
let ar3 = ['one', 'two', 3, 4, true, false, 5];
...
let ar4 = ['one', 'two', 3, 4, true, false, 5, 'nine', 10];

function f4() {
    let con = '';
    for (let i = 0; i < ar4.length; i++) {
        if (ar4[i] === ar4[0] || ar4[i] === ar4[3] || ar4[i] === ar4[8]) {
            con += ar4[i] + ' ';
        };
    };
    document.querySelector('.out-4').textContent = con;
}
...
let ar5 =  [11, 2, 5, 64, 7, 6, 47, 0, 9, 10];

function f5() {
    let sum = 0;
    for (let i = 0; i < ar5.length; i++) {
        if (ar5[i] === ar5[0] || ar5[i] === ar5[2] || ar5[i] === ar5[3]) {
            sum = sum + ar5[i];
        };
    };
...
function f9() {
    let endNum = '';
    endNum = ar9[ar9.length - 1];
    document.querySelector('.out-9').textContent = endNum;
}
...
function f11() {
    ...
    document.querySelector('.out-11').textContent = arr;
}
...
function f12() {
    ...
    document.querySelector('.out-12').textContent = arr;
}
...
function f13() {
    ...
    document.querySelector('.out-13').textContent = arr;
}
...
function f14() {
    ...
    document.querySelector('.out-14').textContent = arr;
}
...
function f15() {
    ...
    document.querySelector('.out-15').textContent = arr;
}
...
function f16() {
    ...
    for (let i = 0; i < ar16.length; i++) {
        if (ar16[i] % 2 === 0) {
            ...
            even += ar16_even[ar16_even.length - 1] + ' ';
        }else if (ar16[i] % 2 != 0) {
            ar16_odd.push(ar16[i]);
            odd += ar16_odd[ar16_odd.length - 1] + ' ';
        };
    };
