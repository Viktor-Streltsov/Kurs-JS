...
function f11() {
    ...
    let rez = d11.indexOf(inp);
    document.querySelector('.out-11').textContent = rez;
}
...
function f18() {
    ...
    let rez = d18.includes(inp);
    document.querySelector('.out-18').textContent = rez;
}
...
function f20() {
    let rez = d20.join('');
    document.querySelector('.out-20').textContent = rez;
}
