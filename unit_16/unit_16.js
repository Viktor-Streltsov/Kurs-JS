...
function f1() {
    ...
    document.querySelector('.out-1').textContent = arr;
}
...
function f2() {
    ...
    document.querySelector('.out-2').textContent = arr;
}
...
function f3() {
    let outS = document.getElementsByClassName('out-3');
...
function f4() {
    let allD = document.querySelectorAll('.out-4');
    for (let item of allD) {
        item.textContent += 4;
    };
};
