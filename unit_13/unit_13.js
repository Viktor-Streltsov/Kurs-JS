...
function f6() {
    let inpKey = document.querySelector('.i-61').value;
    let inpZnach = document.querySelector('.i-62').value;
    let out = '';
    a6[inpKey] = inpZnach;
    for (let obj in a6) {
        out += `${obj}: ${a6[obj]}, <br>`;
...
function f7() {
    let inpKey = document.querySelector('.i-7').value;
    let num = 0;
    for (let obj in a7) {
        if (obj == inpKey) {
            num = 1;
...
function f8() {
    let inpKey = document.querySelector('.i-8').value;
    let rez = 0;
    for (let obj in a8) {
        if (obj == inpKey) {
            rez = a8[obj];
    ...
    document.querySelector('.out-8').textContent = rez;
}
...
function f9() {
    let inpZnach = document.querySelector('.i-9').value;
    let rez = '';
    for (let obj in a9) {
        if (a9[obj] == inpZnach) {
            rez += `${obj} `;
    ...
    document.querySelector('.out-9').textContent = rez;
}
...
function f11() {
    let inpKey = document.querySelector('.i-11').value;
    for (let key in a11) {
        if (key == inpKey) {
            delete a11[key];
        };
...
function f12() {
    let inpZnach = document.querySelector('.i-12').value;
    for (let znach in a12) {
        if (a12[znach] == inpZnach) {
            delete a12[znach];
        };
    };
    f5 (a12, '.out-12');
...
function f17() {
    let out = '';
    for (let key in a17) {
        for (let twoKey in a17[key]) {
            if (a17[key][twoKey] > 30){
                out = a17[key]['name'];
            };
        };
    };
...
function f19() {
    ...
    if (!vetka) {
        ...
        let vod = vetka[0].toUpperCase() + vetka.slice(1);
        for (let key in a19) {
