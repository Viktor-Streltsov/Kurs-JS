...
function t4(event) {
    ...
    let str = document.querySelector('.i-4').value.toLowerCase();
...
function t5(event) {
    console.log(event);
    let str = document.querySelector('.i-5').value.toUpperCase();
...
function t6(event) {
    ...
    document.querySelector('.i-6').value = str1;
    return false;
}
...
function t7() {
    let ran = Math.floor(Math.random() * a7.length);
    document.querySelector('.out-7').textContent = a7[ran];
}
...
function t8(event) {
    ...
    document.querySelector('.out-8').textContent += str2;
}
...
function t11(event) {
    ...
    let divs = document.getElementsByClassName('keyboard');
    for (let j = 0; j < divs.length; j++) {
        divs[j].classList.remove('active');
    };
    for (let i = 0; i < divs.length; i++) {
        if (event.key.toLowerCase() == divs[i].getAttribute('data')) {
            divs[i].classList.add('active');
        }else if (event.code.toLowerCase() == divs[i].getAttribute('data')) {
            divs[i].classList.add('active');
        };
    };
}
...
//         }else if (event.key == elem.getAttribute('data')) {
//             elem.classList.add('active');
//         };
//     })
// }
