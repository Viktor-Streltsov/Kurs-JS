...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&&action=4&&num1=1&&num2=10')
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&&action=6&&num1=34&&num2=65')
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&&action=3&&num1=5&&num2=9',
    })
    .then(data => {
        return data.text();
    })
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&&action=4&&num1=0&&num2=10',
    })
    .then(data => {
        return data.text();
    })
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&&action=6&&num1=87&&num2=23',
    })
    .then(data => {
        return data.text();
    })
