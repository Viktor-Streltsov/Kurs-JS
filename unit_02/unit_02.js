...
let d = 9;
let deli = c / d;
document.querySelector('.out-2').textContent = deli;
...
let f = 5;
let sum1 = e + f;
document.querySelector('.out-3').textContent = sum1;
...
let e1 = '3';
let f1 = 5;
let sum2 = e1 + f1; // Конкатинация, так как один из элементо является String, что бы сработало сложение добавить + к переменной e1. 
document.querySelector('.out-4').textContent = sum2; 
...
let f2 = 0;
let deli2 = e2 / f2;
document.querySelector('.out-5').textContent = deli2;
...
let f3 = 'Hello';
let sum3 = e3 + f3;
document.querySelector('.out-6').textContent = sum3;
...
let f4 = 'Hello';
let multi4 = e4 * f4;
document.querySelector('.out-7').textContent = multi4;
...
function t9() {
    let inpIn = document.querySelector('.i-9').value;
    document.querySelector('.out-9').textContent = +inpIn;
...
function t10() {
    ...
    let multi = inp * 20;    
    document.querySelector('.out-10').textContent = multi;
}
...
function t12() {
    ...
    document.querySelector('.out-12').textContent = 'Hello ' + inp1 + ' ' + inp2;
}
...
function t13() {
    ...
    document.querySelector('.out-13').textContent = a + b; // Также можно жестко преобразовать написав Namber().
}
