...
function t10() {
    ...
    document.querySelector('.out-10').textContent = years;
}
...
function t14() {
    let allInp = document.querySelectorAll('.i-14');
    for (let i = 0; i < allInp.length; i++) {
        if (allInp[i].checked) {
            document.querySelector('.out-14').textContent = allInp[i].value;
        };
    };
}
