...
function t3(event) {
    let elem1 = document.querySelector('.div-31');
    let elem2 = document.querySelector('.div-32');
    if (event.path[0] == elem1) {
        document.querySelector('.out-3').textContent = 1;
    }else if (event.path[0] == elem2) {
        document.querySelector('.out-3').textContent = 2;
    };
}

// ваше событие здесь!!!
document.querySelector('.div-31').addEventListener('touchstart', t3);
document.querySelector('.div-32').addEventListener('touchstart', t3);
...
function t6() {
    document.querySelector('.out-6').textContent += ' touchand';
}
...
function t8() {
    ...
    let ran = Math.floor(Math.random() * a8.length);
    block.style.background = a8[ran];
}
...
function t9(event) {
    let touch = event.touches.length;
    document.querySelector('.out-9').textContent = touch;
}
...
function t11(event) {
    ...
    document.querySelector('.out-11').innerHTML = `radiusX : ${x} <br> radiusY : ${y}`;
}
...
const imaBig = document.querySelector('.img-12-max');
