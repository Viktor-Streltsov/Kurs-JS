...
function f4() {
    let rezul = document.querySelector('.i-4');
   if (rezul.checked) {
       document.querySelector('div.out-4').textContent = rezul.checked;
   }else {
       document.querySelector('div.out-4').textContent = rezul.checked;
   };
}
...
function f5() {
    let rezul = document.querySelector('.i-5');
    if (rezul.checked) {
        document.querySelector('div.out-5').textContent = rezul.value;
    }else {
        document.querySelector('div.out-5').textContent = rezul.checked;
    }
}
...
function f6() {
    ...
    document.querySelector('div.out-6').textContent = inp;
}
...
function f7() {
    ...
    if (password.length >= 6) {
        document.querySelector('div.out-71').textContent = password;
        document.querySelector('div.out-72').textContent = 1
    }else {
        document.querySelector('div.out-71').textContent = password;
        document.querySelector('div.out-72').textContent = 0;
    };
}
...
function f9() {
    let radioValue = document.querySelector('.r-9');
    if (radioValue.checked) {
        document.querySelector('div.out-9').textContent = radioValue.value;
    }else {
        document.querySelector('div.out-9').textContent = radioValue.checked;
    }
}
...
function f10() {
    let colorInput = document.querySelector('.i-10').value;
    document.querySelector('div.out-10').style.background = colorInput;
}
...
function f11() {
    let oneColor = document.querySelector('.i-111').value;
    document.querySelector('.i-112').value = oneColor;
}
...
function f12() {
    let youDate = document.querySelector('.i-12').value;
    document.querySelector('div.out-12').textContent = youDate;
}
...
function f13() {
    ...
    document.querySelector('div.out-13').textContent = num;
}
...
function f14() {
    ...
    document.querySelector('div.out-14').textContent = text;
}
...
function f15() {
    let inpText = document.querySelector('.i-15').value;
    document.querySelector('.t-15').textContent = inpText;
    document.querySelector('div.out-15').textContent = inpText;
}
...
function f16() {
    ...
    let u = document.querySelector('.s-16');
    document.querySelector('div.out-16').textContent = u.value;
}
...
function f17() {
    let num = document.querySelector('.s-17').value;
    document.querySelector('div.out-17').textContent = num;
}
...
function f18() {
    let inp = document.querySelector('.s-18').value;
    document.querySelector('.i-18').value = inp;
}
...
function f19() {
    let textDiva = document.querySelector('div.out-19').textContent;
    document.querySelector('.i-19').value = textDiva;
}
...
function f20() {
    let numValue = document.querySelector('.s-201').value;
    document.querySelector('.s-202').value = numValue;
}
