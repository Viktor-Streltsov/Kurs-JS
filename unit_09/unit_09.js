...
function f1() {
    ...
    outOne.style.width = '200px';
    outOne.style.height = '90px';
}
...
function f2() {
    ...
    outTwo.classList.add('bg-orange');
}
...
function f3() {
    let outTree = document.querySelector('.out-3');
    outTree.classList.remove('bg-orange');
}
...
function f4() {
    ...
    outFour.classList.toggle('bg-orange');
}
...
function f5() {
    let checkClass = document.querySelector('.out-4').classList.contains('bg-orange');
    document.querySelector('.out-5').textContent = checkClass;
}
...
function f6() {
    let par = document.querySelectorAll('p.p-6');
    let num = '';
    let i = 0;
    while (i < par.length) {
        i++;
...
function f11() {
    let nawDiv = document.createElement('div');
    nawDiv.textContent = '25';
    document.querySelector('.out-11').append(nawDiv);
}
...
function f18() {
    ...
    let data = par.getAttribute('data-b');
...
function f19() {
    let par = document.querySelectorAll('.p-19');
    let str = '';
    for (let i = 0; i < par.length; i++) {
        str += par[i].getAttribute('data-b') + ' ';
    };
...
function f20() {
    let theDiv = document.querySelector('div.out-20');
    theDiv.setAttribute('title', 'go');
}
