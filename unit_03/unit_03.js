...
function f4(){
    let yers = document.querySelector('.i-4').value;
    let age = 2022 - yers;
    if (age >= 18) {
...
function f9(){
    let numRom = document.querySelector('.i-9').value;
    if (numRom >= 1 && numRom <= 32) {
        document.querySelector('.out-9').textContent = 1;
    }else if (numRom >= 33 && numRom <= 43) {
        document.querySelector('.out-9').textContent = 2;
    }else if (numRom >= 44 && numRom <= 64) {
...
function f13(){
    let a = document.querySelector('.i-130').value; // Что бы typeof покозал number нужно переменую а преобразовать ы число.
...
function f15(){
    ...
    switch (oper) {
        case '&&':
            document.querySelector('.out-15').textContent = num1 && num2;
            break;
        case '||':
            document.querySelector('.out-15').textContent = num1 || num2;
            break; 
