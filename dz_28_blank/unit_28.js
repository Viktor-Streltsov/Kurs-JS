...
let goods = new Goods('Mars', 54, 'http://pngimg.com/uploads/snickers/snickers_PNG13935.png', 30);
console.log(goods);
 //Task 2.
...
let goods2 = new Goods('Mars', 54, 'http://pngimg.com/uploads/snickers/snickers_PNG13935.png', 25);
let newEl = goods2.drow();
document.querySelector('.out-4').append(newEl);
 //Task 5.
...
let goods3 = new Goods2('Mars', 54, 'http://pngimg.com/uploads/snickers/snickers_PNG13935.png', 20, true);
let newEl2 = goods3.drow();
document.querySelector('.out-6').append(newEl2);
 // Task 7.
...
let valid = new Valid('@email.ru', 'df2w4');
let valPas = valid.validade();
console.log(valPas);
...
let vol = new Valid('Jon', 'dhf4875');
let volName = vol.validade();
console.log(volName);
...
let valid3 = new Valid2('@email.ru', '1234567');
let errorV = valid3.validade();
console.log(valid3);
